...
Auto Mouse Mover Tool (prevents system sleep or lock)

用法 / Usage:
  auto-mouse-mover [选项 / options]
...
示例 / Examples:
  ...
  auto-mouse-mover -i 120 -d 3600     # 每120秒移动一次，运行1小时 / Move every 120s, run 1 hour

别名 / Alias:
  可以使用 'amm' 作为 'auto-mouse-mover' 的简短别名
  You can use 'amm' as a short alias for 'auto-mouse-mover'
    `);
    process.exit(0);
  }
}
